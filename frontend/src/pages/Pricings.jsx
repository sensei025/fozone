    ...
    <div className="space-y-6 md:space-y-8 w-full">
      ...
      {zones.length === 0 ? (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
          <Wifi className="mx-auto text-gray-400 mb-4" size={48} strokeWidth={2} />
            ...
            <>
              {pricings.length === 0 ? (
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 md:p-12 text-center">
                  <Tag className="mx-auto text-gray-400 mb-4" size={48} strokeWidth={2} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                  {pricings.map((pricing) => (
                    <div
                      key={pricing.id}
                      className="group bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5 md:p-6 hover:shadow-lg hover:border-primary-200 dark:hover:border-primary-800 transition-all duration-200"
                    >
...
function CreatePricingForm({ zoneId, zoneName, onCancel, onSuccess, editingPricing }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 md:p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          <div className="p-2 bg-primary-100 dark:bg-primary-900/20 rounded-lg">
            <Tag className="text-primary-600 dark:text-primary-400" size={20} strokeWidth={2.5} />
          </div>
      ...
      {/* Notice importante */}
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 md:p-4 mb-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-3 sm:gap-4 pt-4 md:pt-6 border-t border-gray-200 dark:border-gray-700">
          <button
            type="button"
            onClick={onCancel}
            className="btn btn-secondary order-2 sm:order-1 flex items-center justify-center gap-2"
          >
